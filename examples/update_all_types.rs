...
fn main() -> Result<()> {
    ...
    match TomlParser::update_version(project_path, &new_version) {
        Ok(files) => {
    ...
    match PackageJsonParser::update_version(project_path, &new_version) {
        Ok(files) => {
    ...
    match TauriConfigParser::update_version(project_path, &new_version) {
        Ok(files) => {
